...
export declare class CreateLabelRequest extends Message<CreateLabelRequest> {
   ...
   * Label being updated
   *
   * @generated from field: musicservice.Label label = 1;
   */
  label?: Label;
  ...
  static readonly typeName = "musicservice.CreateLabelRequest";
...
export declare class CreateLabelResponse extends Message<CreateLabelResponse> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "musicservice.CreateLabelResponse";
  static readonly fields: FieldList;
...
export declare class UpdateLabelRequest extends Message<UpdateLabelRequest> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "musicservice.UpdateLabelRequest";
  static readonly fields: FieldList;
...
export declare class UpdateLabelResponse extends Message<UpdateLabelResponse> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "musicservice.UpdateLabelResponse";
  static readonly fields: FieldList;
...
export declare class GetLabelsRequest extends Message<GetLabelsRequest> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "musicservice.GetLabelsRequest";
  static readonly fields: FieldList;
...
export declare class GetLabelsResponse extends Message<GetLabelsResponse> {
   ...
   *
   * @generated from field: map<string, musicservice.Label> labels = 1;
   */
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "musicservice.GetLabelsResponse";
  static readonly fields: FieldList;
...
export declare class ListLabelsRequest extends Message<ListLabelsRequest> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "musicservice.ListLabelsRequest";
  static readonly fields: FieldList;
...
export declare class ListLabelsResponse extends Message<ListLabelsResponse> {
   ...
   *
   * @generated from field: repeated musicservice.Label labels = 1;
   */
  labels: Label[];
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "musicservice.ListLabelsResponse";
  static readonly fields: FieldList;
...
export declare class DeleteLabelRequest extends Message<DeleteLabelRequest> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "musicservice.DeleteLabelRequest";
  static readonly fields: FieldList;
...
export declare class DeleteLabelResponse extends Message<DeleteLabelResponse> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "musicservice.DeleteLabelResponse";
  static readonly fields: FieldList;
...
export declare class AddAlbumRequest extends Message<AddAlbumRequest> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "musicservice.AddAlbumRequest";
  static readonly fields: FieldList;
...
export declare class AddAlbumResponse extends Message<AddAlbumResponse> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "musicservice.AddAlbumResponse";
  static readonly fields: FieldList;
...
export declare class RemoveAlbumRequest extends Message<RemoveAlbumRequest> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "musicservice.RemoveAlbumRequest";
  static readonly fields: FieldList;
...
export declare class RemoveAlbumResponse extends Message<RemoveAlbumResponse> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "musicservice.RemoveAlbumResponse";
  static readonly fields: FieldList;
 ...
 */
export declare class ListAlbumsInLabelRequest extends Message<ListAlbumsInLabelRequest> {
  /**
   *
   * Instead of an offset an abstract  "page" key is provided that offers
   * an opaque "pointer" into some offset in a result set.
  ...
  constructor(data?: PartialMessage<ListAlbumsInLabelRequest>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "musicservice.ListAlbumsInLabelRequest";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): ListAlbumsInLabelRequest;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): ListAlbumsInLabelRequest;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): ListAlbumsInLabelRequest;

  static equals(a: ListAlbumsInLabelRequest | PlainMessage<ListAlbumsInLabelRequest> | undefined, b: ListAlbumsInLabelRequest | PlainMessage<ListAlbumsInLabelRequest> | undefined): boolean;
}
 ...
 */
export declare class ListAlbumsInLabelResponse extends Message<ListAlbumsInLabelResponse> {
  /**
   *
   * List of albums.
   *
   * @generated from field: repeated musicservice.Album albums = 1;
   */
  albums: Album[];
  ...
  constructor(data?: PartialMessage<ListAlbumsInLabelResponse>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "musicservice.ListAlbumsInLabelResponse";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): ListAlbumsInLabelResponse;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): ListAlbumsInLabelResponse;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): ListAlbumsInLabelResponse;

  static equals(a: ListAlbumsInLabelResponse | PlainMessage<ListAlbumsInLabelResponse> | undefined, b: ListAlbumsInLabelResponse | PlainMessage<ListAlbumsInLabelResponse> | undefined): boolean;
}
